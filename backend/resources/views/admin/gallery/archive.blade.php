...
@section('content')
<div class="container" id="admin-gallery-archive" data-animate="animate__fadeInUp animate__delay-05s">
  <div class="admin-shell">
    ...
    <main class="admin-content">
      <div class="admin-topbar">
        <div class="admin-title">Gallery Archive</div>
        <div class="admin-actions">
          <a href="/admin/gallery" class="btn btn-login-secondary">← Back to Gallery</a>
          <div class="admin-user">{{ session('admin_name') }}</div>
        </div>
      </div>

      <div class="panel panel-default">
        <div class="panel-heading">Archived Images</div>
          ...
          @forelse($items as $item)
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <form method="POST" action="/admin/gallery/{{ $item->id }}/unarchive" style="display:inline-block;">
                  @csrf
