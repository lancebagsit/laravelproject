    ...
    <main class="admin-content">
      <div class="admin-topbar">
        ...
        <div class="admin-actions">
          ...
          <a href="/admin/priest/archive" class="btn btn-login-secondary">View Archive</a>
          ...
          @forelse($items as $item)
            <div class="panel panel-info">
              ...
              <div class="panel-body">
                ...
                <button type="button" class="btn btn-danger" style="margin-left:10px;" data-toggle="modal" data-target="#del-priest-{{ $item->id }}">Delete</button>
                <form method="POST" action="/admin/priest/{{ $item->id }}/archive" style="display:inline-block; margin-left:10px;">
                  @csrf
                  <button type="submit" class="btn btn-login-secondary">Archive</button>
                </form>
                <div class="modal fade" id="del-priest-{{ $item->id }}" tabindex="-1" role="dialog">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header"><h4 class="modal-title">Confirm Delete</h4></div>
                      <div class="modal-body"><p>Are you sure you want to delete this priest?</p></div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-login-secondary" data-dismiss="modal">Cancel</button>
                        <form method="POST" action="/admin/priest/{{ $item->id }}/delete" style="display:inline;">
                          @csrf
